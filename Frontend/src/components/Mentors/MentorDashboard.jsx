    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="container h-full p-4 mx-auto">
          <div className="bg-[#1b0a5f] dark:bg-gray-800 text-white flex flex-col items-center justify-center p-4 rounded-md shadow-lg">
          ...
          {/* Notification Banner */}
          {!profileComplete && (
            <div className="mt-4 p-4 bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-300 rounded-md shadow">
              <p>
        ...
        <div className="container mx-auto p-4 px-4">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/2 space-y-4 flex flex-col items-center pt-6">
              ...
              {hasMatchedMentee && (
                <div className="p-4 mt-4 rounded-md w-full md:w-[95%] shadow bg-sky-50 dark:bg-gray-800">

...
const MentorProfile = ({ token, onProfileUpdate }) => {
  ...
  if (!mentor) return <div className="text-center mt-10 text-gray-900 dark:text-white">Loading...</div>;
    ...
    <div className="px-4 py-6 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <div className="bg-sky-50 dark:bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 space-y-4">
        ...
        <div className="flex justify-center items-center px-4 pt-6 gap-4">
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Team Member 1</p>
            <img
              src={
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Team Member 2</p>
            <img
              src={
        ...
        <div className="flex flex-col items-center text-center py-4">
          <p className="font-bold text-xl text-gray-700 dark:text-gray-300 mb-1">Interests:</p>
        ...
        <div className="flex flex-col items-center text-center py-4">
          <p className="font-bold text-xl text-gray-700 dark:text-gray-300 mb-1">Question:</p>
        ...
        <div className="bg-sky-100 dark:bg-gray-700 p-4 rounded-md text-center">
          ...
          <div className="flex items-center justify-center">
            <p className="font-bold text-xl text-gray-700 dark:text-gray-300 mr-2">Email:</p>
            <span className="text-blue-500 dark:text-blue-400 text-xl font-bold">
              {mentor.email}
            </span>
          </div>

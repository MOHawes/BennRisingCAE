...
import {
  API_CONSENT_FORM_SUBMIT,
  API_CONSENT_FORM_INFO,
...
const ParentConsentForm = () => {
  ...
  const fetchMatchInfo = async () => {
    try {
      const response = await fetch(
        `${API_CONSENT_FORM_INFO}/${matchRequestId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_CONSENT_FORM_SUBMIT}/${matchRequestId}`,
        {
          method: "POST",
          headers: {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  Your child <strong>{matchInfo.menteeName}</strong> has
                  requested to join a project team with:
                </p>
                <p className="text-sm text-blue-700 mt-1">
                  <strong>{matchInfo.mentorName}</strong> -{" "}
                  {matchInfo.projectCategory} Project
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {menteeFirstName && (
              <div className="text-center mb-4">
                <p className="text-lg text-gray-700">
                  Please complete this consent form for{" "}
                  <strong>{menteeFirstName}</strong>'s participation in the
                  Bennington Rising Program.
                </p>
              </div>
            )}
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-md">
              ...
              <p className="text-sm text-red-700 mb-4">
                Please provide a secondary emergency contact (someone other than
                yourself) who can be reached if needed.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Parent/Legal Guardian">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              <label className="flex items-start cursor-pointer">
                ...
                <span className="text-sm text-gray-700">
                  I confirm that I have reviewed the Bennington Rising Program
                  consent form PDF above <span className="text-red-500">*</span>
                </span>
              </label>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-start cursor-pointer hover:bg-green-50 p-2 rounded-md transition-colors">
                  ...
                  />
                  <span className="text-sm text-gray-700">
                    I approve my child's participation in the Bennington Rising
                    Program
                  </span>
                </label>
                ...
                <label className="flex items-start cursor-pointer hover:bg-red-50 p-2 rounded-md transition-colors">
                  ...
                  />
                  <span className="text-sm text-gray-700">
                    I do not approve of my child's participation in the
                    Bennington Rising Program
                  </span>
                </label>
              </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          ...
          <p>
            <a
              href="mailto:james.trimarchi@svhealthcare.org"
              className="text-blue-600 hover:underline"
            >
